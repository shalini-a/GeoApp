...
/**
 * Created by shagniho on 1/27/2017.
 */
    ...
    public Location getLocation() {
        try {
            ...
            if (!isGPSEnabled && !isNetworkEnabled) {
                Toast.makeText(mContext, "Please enable GPS or turn on network!!", Toast.LENGTH_LONG).show();
            } else {
                ...
                if (isNetworkEnabled) {
                    ...
                    if (ActivityCompat.checkSelfPermission((Activity)mContext, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission((Activity)mContext, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
                        Log.d("shalini", "permission not granted");
                        return null;
                    }
                ...
                Log.d("shalini", "isNetworkEnabled "+isNetworkEnabled);
                ...
                Log.d("shalini", "isGPSEnabled "+isGPSEnabled);
            }
